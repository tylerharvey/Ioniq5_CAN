...
\begin{abstract}
  ...
  \begin{description}
    \item[Step 1: Disconnect 12V] TBD
    ...
    \item[Step 3: Harness Connection] \href{https://youtu.be/JgrhReAnDGc}{harness connection guide}
    \item[Step 4: OBD Mount] \href{https://youtu.be/UDeqbYXpMZo}{OBD mount guide}
    \item[Step 4.5: WiCAN Plug-In] \href{https://youtu.be/d--er3wadJ4}{Plug in WiCAN}
  \end{description}
\end{abstract}
...
Reverse the trim removal steps. Make sure trim clips are aligned, and then firmly pop the trim panels back into place. Reconnect 12V battery negative terminal. The WiCAN should immediately show a blue light.
\appendix 
