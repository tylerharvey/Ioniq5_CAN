...
\begin{abstract}
  This guide walks you through the steps needed to change the mode of your head unit man-in-the-middle (MITM) harness between MITM and parallel modes. This is a troubleshooting or advanced DIY step. See also the \url{https://youtu.be/sWzxWfUpCfs}{video guide}.
\end{abstract}
