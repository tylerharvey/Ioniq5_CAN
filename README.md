...
I am also including the source files [1](./M-CAN_dongle_001.yml) and [2](./M-CAN_dongle_003.yml) used to render the drawings with [wireviz](https://github.com/wireviz/WireViz/).
...
# Parsing
One approach to [parsing](tools/parsing_MWE.ipynb) depends at least in part on interesting timestamp tagging to limit the noise. In our case, this was made possible by dragz's manual discoveries of preconditioning indicator messages.
